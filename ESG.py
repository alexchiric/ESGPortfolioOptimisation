...
mylist = ["MMM", "AXP", "AAPL", "BA", "CAT", "CVX", "CSCO", "KO", "DOW", "XOM",
          ...
          "PG", "RTX", "TRV", "UNH", "VZ", "V", "WBA", "WMT", "DIS"]
...
ESG_list = [75.51, 22.31, 13.68, 78.88, 73.85, 88.39, 3.12, 39.92, 20.00, 77.93,
            ...
            55, 18.04, 23.54, 16.69, 11.41, 18.01, 49.23, 9]


def ESG_Portf(S, mylist, ESG):
    n = len(mylist)
    w = cp.Variable(n)
...
weights_meanvar = Mean_Variance(S, mylist)
weights_ESG = ESG_Portf(S, mylist, ESG_arr)
